...
const featuresData = [
  {
    ...
    description:
      "Easily manage patients’ medical records, appointments, and billing information. The system will provide a central database that can be accessed by authorized healthcare providers from anywhere at any time.",
  },
  {
    icon: "assignment",
    title: "Appointment Scheduling",
    description:
      "Allows patients to make appointments online and view their schedules. Patients can also manage their appointments, reschedule or cancel appointments with ease.",
  },
  {
    icon: "gear",
    title: "Inventory Management",
    description:
      "Manages inventory and supplies in a healthcare facility. The system automatically tracks the supplies’ usage and reorders when needed. The inventory reports help in planning for future supplies purchases.",
  },
];
...
export const specializationArr = [
  { value: "All", label: "All" },
...
export const cities = {
  ...
  "Himachal Praddesh": [{ value: "Manali", label: "Manali" }],
  "Arunachal Pradesh": [
